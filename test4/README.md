...
![image-20210421164223787](image-20210421164223787.png)
...
![image-20210421164400986](image-20210421164400986.png)
...
##### 3. 在EMPLOYEES表的NAME字段创建索引

![image-20210421164522583](image-20210421164522583.png)
...
##### 4. 为EMPLOYEES表增加外键和约束

![image-20210421164538424](image-20210421164538424.png)
...
ALTER TABLE EMPLOYEES
ADD CONSTRAINT EMPLOYEES_CHK1 CHECK (SALARY>0) ENABLE;

ALTER TABLE EMPLOYEES
ADD CONSTRAINT EMPLOYEES_CHK2 CHECK (EMPLOYEE_ID<>MANAGER_ID) ENABLE;

ALTER TABLE EMPLOYEES
ADD CONSTRAINT EMPLOYEES_EMPLOYEE_MANAGER_ID CHECK (MANAGER_ID<>EMPLOYEE_ID) ENABLE;

ALTER TABLE EMPLOYEES
ADD CONSTRAINT EMPLOYEES_SALARY CHECK (SALARY>0) ENABLE;
```

##### 5. 创建PRODUCTS表并添加约束

![image-20210421164554831](image-20210421164554831.png)

![image-20210421164607001](image-20210421164607001.png)
...
ADD CONSTRAINT PRODUCTS_CHK1 CHECK(PRODUCT_TYPE IN ('耗材', '手机', '电脑')) ENABLE;
```

##### 6. 创建数据临时存储的ORDER_ID_TEMP表

![image-20210421164632639](image-20210421164632639.png)
...
![image-20210421164644549](image-20210421164644549.png)
...
![image-20210421164656013](image-20210421164656013.png)
...
![image-20210421164709131](image-20210421164709131.png)

```sql
ALTER TABLE ORDERS
ADD CONSTRAINT ORDERS_PK PRIMARY KEY(ORDER_ID) USING INDEX ORDERS_PK ENABLE;

ALTER TABLE ORDERS
ADD CONSTRAINT ORDERS_FK1 FOREIGN KEY(EMPLOYEE_ID) REFERENCES EMPLOYEES(EMPLOYEE_ID) ENABLE;
```

##### 10. 创建ORDER_DETAILS表、ORDER_DETAILS表的索引和外键约束

![image-20210421164746350](image-20210421164746350.png)

![image-20210421164802236](image-20210421164802236.png)

![image-20210421164829758](image-20210421164829758.png)
...
ADD CONSTRAINT ORDER_DETAILS_PK PRIMARY KEY (ID) USING INDEX ORDER_DETAILS_PK ENABLE;

CREATE INDEX ORDER_DETAILS_ORDER_ID ON ORDER_DETAILS (ORDER_ID)
GLOBAL PARTITION BY HASH (ORDER_ID)(
  PARTITION INDEX_PARTITION1 TABLESPACE USERS NOCOMPRESS, 
  PARTITION INDEX_PARTITION2 TABLESPACE USERS02 NOCOMPRESS);

ALTER TABLE ORDER_DETAILS
ADD CONSTRAINT ORDER_DETAILS_PRODUCT_NUM CHECK (Product_Num>0) ENABLE;
```

##### 11. 创建3个触发器并暂时将其关闭

![image-20210421164930154](image-20210421164930154.png)

![image-20210421164943981](image-20210421164943981.png)

![image-20210421164957741](image-20210421164957741.png)
...
![image-20210421165038266](image-20210421165038266.png)
...
##### 13. 在DEPARTMENTS表、EMPLOYEES表和products表中插入约束数据

![image-20210421165151488](image-20210421165151488.png)

![image-20210421165202224](image-20210421165202224.png)

![image-20210421165219643](image-20210421165219643.png)
